...
// Add custom wrapper to fix missing pb_release function
#ifndef PB_RELEASE_DEFINED
#define PB_RELEASE_DEFINED
#include <nanopb/pb_common.h>
static inline void pb_release_inline(const pb_msgdesc_t *fields, void *dest_struct) {
    pb_release(fields, dest_struct);
}
#define pb_release pb_release_inline
#endif
